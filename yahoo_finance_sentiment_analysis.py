...
headline_links = ['/news/alphabets-nasdaq-googl-15-cagr-130019156.html', '/news/alphabet-googl-boosts-reach-europe-145702600.html', '/news/googles-chatgpt-gambit-sundar-pichai-175125233.html'
                  , '/news/time-sundar-pichai-step-more-171749423.html', '/m/6e8e5f25-6e47-3282-9509-1e124d601b37/alphabet-s-youtube-has-a.html', '/m/57cccc1b-61b1-3fb8-9c2d-ae4a48d2a530/new-to-investing-here-are.html', '/news/5-ways-save-money-digital-114115082.html', '/news/us-stocks-wall-street-ends-202036744.html' ]
all_articles_list = []
relevant_articles = []
searched_articles = []
recently_published = []
...
def search_keywords():
    ...
    positive_keywords = ["higher than expected", "outpaced","up from", "increase", "rise", "rose", "ticked up", "outperformed",
